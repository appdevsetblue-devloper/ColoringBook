...
-(void)getColorCodeCompletionBlock:(NSUInteger )byteIndex imageData:(unsigned char *)imageData widthCompletion:(void (^)(NSUInteger colorCode))callback {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        NSUInteger colorCode = (red << 24) | (green << 16) | (blue << 8) | alpha;
